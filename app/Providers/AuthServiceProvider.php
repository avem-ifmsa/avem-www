...
use Avem\Policies\ActivityTaskPolicy;
...
use Avem\Policies\PerformedTaskPolicy;
...
class AuthServiceProvider extends ServiceProvider
{
	...
	protected $policies = [
		...
		ActivityTask::class     => ActivityTaskPolicy::class,
		...
		PerformedTask::class    => PerformedTaskPolicy::class,
