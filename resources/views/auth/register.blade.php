		...
		<div id="app">
			<div class="container">
				<div class="mt-3 col-md-10 offset-md-1 col-lg-8 offset-lg-2">
					...
					Formas de pago: mediante transferencia bancaria a ES93 2038 6166 29 6000459898 enviando una copia del comprobante a tesoreria@avem.es o pagando en metálico en el despacho de AVEM.
					</p>
					<p>
